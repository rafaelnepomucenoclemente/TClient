...
{ TRUE,		MAKELONG( '7', TKEYMOD_NONE),			TSTR_TKEY_SKILL_7,			CString("TKEY_SKILL_7") },			
	...
	{ TRUE,		MAKELONG( 'L', TKEYMOD_NONE),	0,			CString("TKEY_TITLE") },
	{ TRUE,		MAKELONG( VK_OEM_PERIOD, TKEYMOD_NONE),	0,			CString("TKEY_CAUTION15") },
	{ TRUE,		MAKELONG( VK_TAB, TKEYMOD_SHIFT),	0,			CString("TKEY_SHIFTTAB") },
};
// ==================================================================================================
