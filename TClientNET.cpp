...
void CTClientNET::SetTargetSlot( INT nTargetSlot, INT nDir )
{
	...
	m_fTargetROT = GetSlotROT( nTargetSlot ); // 대상 방향
...
void CTClientNET::DefaultPosition( CPoint* vBASIS, BOOL bRestore )
{
	...
	static const DWORD TCHARFRAME_COMP_COUNT = 21;
	...
	else
	{
		...
		// ID_FRAME_CHAR_NEW
		{
			...
			static DWORD vCOMP[TCHARFRAME_COMP_COUNT][2] =
			{
				...
				{ ID_SERVERS_GROUP, TBASISPOINT_CENTER_TOP},
				{ ID_SERVERS_CHANNEL, TBASISPOINT_CENTER_TOP},
				{ ID_SERVERS_ICON, TBASISPOINT_CENTER_TOP},
				{ ID_SERVERS_TEXT,TBASISPOINT_CENTER_TOP},
				{ ID_SERVERS_FRAME,TBASISPOINT_CENTER_TOP}
			};
...
void CTClientNET::ChangeBACK( DWORD toState )
{
	...
	{
		{ ID_OBJECT_33110,	ID_OBJECT_33120, ID_OBJECT_33130},
	{ ID_OBJECT_33110,	ID_OBJECT_33120, ID_OBJECT_33130},
	{ ID_OBJECT_33110,	ID_OBJECT_33120, ID_OBJECT_33130}
	};
