...
// ======================================================================
CTClientPet* CTPetDlg::MakeSaddle(WORD wItemID, const CTime& tEndTime)
{
	CString it;
	it.Format("Trace1: %d",wItemID);
CTClientPet* pPet = new CTClientPet;
	MessageBox(NULL,it,"Trace1",2);
	pPet->wSaddleID = wItemID;
	pPet->m_tSaddleTime = tEndTime;
	//pPet->SetSaddle(wItemID, tEndTime);
	return pPet;
}
