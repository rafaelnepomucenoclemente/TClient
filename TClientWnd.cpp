							    ...
							    BYTE bGroupID)
{
	...
	static DWORD dwGaugeID[][7] = {
		...
		{ ID_FRAME_MAIN,	ID_FRAME_MAIN_CENTER,	ID_CTRLINST_EXP,		TGS_GROW_RIGHT, TEXPNEW_COLOR,		TTEXTSHADOW_COLOR, FALSE},		//TGAUGE_PLAYER_EXP
	//	{ ID_FRAME_MAIN,	ID_FRAME_MAIN_CENTER,	ID_CTRLINST_LOT,		TGS_GROW_RIGHT, TEXPNEW_COLOR,		TTEXTSHADOW_COLOR, FALSE},		//TGAUGE_PLAYER_EXP
	...
	static DWORD dwTextID[][5] = {
		{ ID_FRAME_MAIN,	ID_FRAME_MAIN_CENTER,	ID_CTRLINST_EXP_TEXT,		TEXPNEW_COLOR,		TTEXTSHADOW_COLOR},	//TTEXT_PLAYER_EXP
	    { ID_FRAME_MAIN,	ID_FRAME_MAIN_CENTER,	ID_CTRLINST_LOT_TEXT,		TLOTNEW_COLOR,		TTEXTSHADOW_COLOR},	//TTEXT_PLAYER_LOT
		{ ID_FRAME_MAIN,	ID_FRAME_MAIN_RIGHT,	ID_CTRLINST_RUNE,			TCOLOR_CHAT_PARTY2,	TTEXTSHADOW_COLOR},	//TTEXT_PLAYER_RUNE
		{ ID_FRAME_MAIN,	ID_FRAME_MAIN_RIGHT,	ID_CTRLINST_LUNA,			TCOLOR_CHAT_PARTY2,	TTEXTSHADOW_COLOR},	//TTEXT_PLAYER_LUNA
		//{ ID_FRAME_MAIN,	ID_FRAME_MAIN_RIGHT,	ID_CTRLINST_CRON,			TCOLOR_CHAT_PARTY2,	TTEXTSHADOW_COLOR},
	  //TTEXT_PLAYER_CRON
	...
	//	{ ID_FRAME_GAUGE,	ID_FRAME_MY_GAUGE, 		ID_CTRLINST_TXT_LEVELCLASS,	TNAMETEXT_COLOR,	TTEXTSHADOW_COLOR},	//TTEXT_PLAYER_CLASS
		...
		{ ID_FRAME_GAUGE,	ID_FRAME_MY_GAUGE, 		ID_CTRLINST_TXT_MP,			TMPTEXT_COLOR,		TTEXTSHADOW_COLOR},
		//TTEXT_PLAYER_MP
...
switch(i)
		...
		case TFRAME_AVSTATUS					: m_MainGame.m_vTFRAME[i] = new CTSkygardenMap( &m_MainGame, pDESC); break;
			case TFRAME_AVWIN					: m_MainGame.m_vTFRAME[i] = new CTSkygardenEnd( &m_MainGame, pDESC); break;
	//	case TFRAME_VETERAN					: m_MainGame.m_vTFRAME[i] = new CTVeteranDlg( &m_MainGame, pDESC); break;
		case TFRAME_HOTSTART					: m_MainGame.m_vTFRAME[i] = new CTHotStartDlg( &m_MainGame, pDESC); break;
		case TFRAME_BOWALARM					: m_MainGame.m_vTFRAME[i] = new CTBowAlarm( &m_MainGame, pDESC); break;
		case TFRAME_BOWREGISTER				: m_MainGame.m_vTFRAME[i] = new CTBowRegister( &m_MainGame, pDESC); break;
		case TFRAME_BOWSTATUS						: m_MainGame.m_vTFRAME[i] = new CTBowStatus( &m_MainGame, pDESC); break;
		//	case TFRAME_ARCHIV						: m_MainGame.m_vTFRAME[i] = new CTCashCabinetDlg( &m_MainGame, pDESC); break;
	//	case TFRAME_HELPNEW						: m_MainGame.m_vTFRAME[i] = new CTDynamicHelpNewDlg( &m_MainGame, pDESC); break;
		case TFRAME_BOWRANK						: m_MainGame.m_vTFRAME[i] = new CTBowRankDlg( &m_MainGame, pDESC); break;
		case TFRAME_BOWREV                      : m_MainGame.m_vTFRAME[i] = new CTBowRevDlg( &m_MainGame, pDESC); break;
		case TFRAME_LOTTERY						: m_MainGame.m_vTFRAME[i] = new CTLotteryDlg( &m_MainGame, pDESC); break;
		case TFRAME_LOTWIN						: m_MainGame.m_vTFRAME[i] = new CTLotWinDlg( &m_MainGame, pDESC); break;
		case TFRAME_RANKING						: m_MainGame.m_vTFRAME[i] = new CTRankingDlg( &m_MainGame, pDESC); break;
		case TFRAME_UIBAR						: m_MainGame.m_vTFRAME[i] = new CTUIBarDlg( &m_MainGame, pDESC); break;
		case TFRAME_POTIONS						: m_MainGame.m_vTFRAME[i] = new CTPotionPannel( &m_MainGame, pDESC); break;
...
//	m_MainGame.m_pNotifyFrame->ShowComponent(FALSE);
...
/*
		...
		m_MainGame.m_pChannelPOPUP = new CTMiniPopupDlg(&m_MainGame, pMINIPOPUPDESC, FALSE);
	m_MainGame.AddKid(m_MainGame.m_pChannelPOPUP);
...
/*
		m_MainGame.m_vNEWFACE[i] = (TImageList *)  m_MainGame.FindKid(dwNEWFaceID[i][2]);
		m_MainGame.m_vNEWFACE[i]->SetCurImage(0);

		m_MainGame.m_vNEWFACE[i]->EnableComponent(FALSE);
		m_MainGame.m_vNEWFACE[i]->ShowComponent(FALSE);
	...
	for( i=0; i<TFACEIMG_COUNT; i++)
	{
		...
		if( dwFaceImgID[i][0] )
		{
            ...
            pTFRAME = (TFrame *) pTPARENT->FindKid(dwFaceImgID[i][1]);
			     ...
			     //   m_MainGame.AddKid(m_MainGame.m_vTFACEIMG[i]);
		
		/*	m_MainGame.AddKid(pTPARENT);
			pTPARENT->AddKid(pTPARENT);
			pTFRAME->AddKid(pTPARENT);
			*/
		}
		else
       ...
       m_MainGame.AddKid(m_MainGame.m_vTFACEIMG[i]);
		pTFRAME->AddKid(m_MainGame.m_vTFACEIMG[i]);
				

			
TGauge *pTPARENT = (TGauge *) m_MainGame.FindKid(ID_CTRLINST_FATIGUE);
	...
	m_MainGame.m_pTPARTYITEM = pMainUI->FindKid(ID_PARTY_IT2);
	...
	// °ÔÀÓ°¡µå.
	if (theApp.m_pNpgl)//if( CTNationOption::RUSSIA && theApp.m_pNpgl )
...
void CTClientWnd::InitTexture()
{
    ...
    //110B83CC
	#define LICH_WEAPONX			(0x110B83CC)
	MAPRES::iterator finder = m_RES.m_mapTEX.find(LICH_WEAPONX);
	if( finder != m_RES.m_mapTEX.end() )
	...
	if( finder != m_RES.m_mapTEX.end() )
		CTClientMAP::m_pPortal = (LPTEXTURESET) (*finder).second;
finder = m_RES.m_mapTEX.find(ID_NPCICON_REVIVAL);
	if( finder != m_RES.m_mapTEX.end() )
		CTClientMAP::m_pChaos = (LPTEXTURESET) (*finder).second;
	...
	finder = m_RES.m_mapTEX.find(LICH_WEAPONX);
	if( finder != m_RES.m_mapTEX.end() )
...
void CTClientWnd::InitUI( BOOL bResetOnlyPosition)
{
	...
	static const DWORD dwPosID[][2] = {
		...
		{ TBASISPOINT_RIGHT_TOP, ID_CTRLINST_SHOP},			//TFRAME_AVALON
		{ TBASISPOINT_CENTER_MIDDLE, ID_CTRLINST_SHOP},			//TFRAME_AVALONX
		//	{ TBASISPOINT_CENTER_BOTTOM, ID_CTRLINST_SHOP},			//TFRAME_VETERAN

		{ TBASISPOINT_RIGHT_TOP, ID_CTRLINST_SHOP},			//TFRAME_HOTSTART
		{ TBASISPOINT_CENTER_BOTTOM, ID_CTRLINST_SHOP},			//TFRAME_BOWALARM
		{ TBASISPOINT_CENTER_MIDDLE, ID_CTRLINST_SHOP},			//TFRAME_TITLE
		{ TBASISPOINT_CENTER_TOP, ID_CTRLINST_SHOP},			//TFRAME_TITLE
		{ TBASISPOINT_CENTER_MIDDLE, ID_CTRLINST_SHOP},			//TFRAME_BOWSTATUS
		{ TBASISPOINT_RIGHT_TOP, ID_CTRLINST_SHOP},			//TFRAME_TITLE
		//	{ TBASISPOINT_CENTER_MIDDLE, ID_CTRLINST_SHOP},			//TFRAME_TITLE
		{ TBASISPOINT_LEFT_TOP, ID_CTRLINST_SHOP},			//TFRAME_TITLE
		{ TBASISPOINT_CENTER_MIDDLE, ID_CTRLINST_SHOP},			//TFRAME_TITLE
		{ TBASISPOINT_CENTER_TOP, ID_CTRLINST_SHOP},			//TFRAME_TITLE
		{ TBASISPOINT_CENTER_MIDDLE, ID_CTRLINST_SHOP},			//TFRAME_TITLE
		{ TBASISPOINT_CENTER_BOTTOM, ID_CTRLINST_SHOP},			//TFRAME_TITLE
		{ TBASISPOINT_CENTER_MIDDLE, ID_CTRLINST_SHOP},			//TFRAME_TITLE
		{ TBASISPOINT_CENTER_MIDDLE, ID_CTRLINST_SHOP},			//TFRAME_TITLE
		{ TBASISPOINT_CENTER_MIDDLE, ID_CTRLINST_SHOP},			//TFRAME_TITLE
		{ TBASISPOINT_CENTER_MIDDLE, ID_CTRLINST_SHOP},			//TFRAME_TITLE
	...
	//	{ TBASISPOINT_CENTER_MIDDLE, ID_CTRLINST_CHAR_INFO},	//TFRAME_TOURNAMENT_MATCH
		...
		{ TBASISPOINT_CENTER_BOTTOM, ID_CTRLINST_GAUGE}, //TFRAME_TOURNAMENT_GAGE
		...
		{ TBASISPOINT_CENTER_MIDDLE, ID_CTRLINST_CHAR_INFO},
		{ TBASISPOINT_RIGHT_TOP, ID_CTRLINST_MESSENGER},//TFRAME_CHALLENGE_ITEM
	...
	static const BYTE bEnable[][3] = { // 1.show, 2.enable float, 3.use basis.
		...
		{ FALSE, TRUE, FALSE},					//TFRAME_AVALON
		{ FALSE, TRUE, FALSE},					//TFRAME_AVALONX
		//{ TRUE, TRUE, FALSE},					//TFRAME_VETERAN
		{ FALSE, FALSE, FALSE},                  //TFRAME_HOTSTART
		{ FALSE, FALSE, FALSE},                  //TFRAME_HOTSTART
		{ FALSE, TRUE, FALSE},					//TFRAME_TITLE
		{ FALSE, FALSE, FALSE},					//TFRAME_BOWSTATUS
		{ FALSE, TRUE, TRUE},					//TFRAME_TITLE
	//	{ FALSE, TRUE, TRUE},					//TFRAME_TITLE
		{ TRUE, TRUE, TRUE},					//TFRAME_TITLE
		{ FALSE, FALSE, FALSE},					//TFRAME_TITLE
		{ FALSE, FALSE, FALSE},					//TFRAME_TITLE
		{ FALSE, FALSE, FALSE},					//TFRAME_TITLE
		{ FALSE, FALSE, FALSE},					//TFRAME_TITLE
		{ FALSE, TRUE, TRUE},					//TFRAME_TITLE
		...
		CTNationOption::PORTUGAL )
	{
		...
		m_MainGame.m_pChatFrame->ChangeSelection(TCHAT_SET_ALL);
	}
	else
	{
		m_MainGame.m_pChatFrame->SetChatMode(CHAT_MAP);
...
void CTClientWnd::InitChart()
{
	...
	CTChart::InitTSADDLETEMP( _T(".\\Tcd\\TMount.tcd") );
	...
	MD5 context(file);
		...
		ifstream filex(".\\Tcd\\TItem.tcd"); // Open file
	MD5 contextx(filex);
		char* pstrx = contextx.hex_digest();
		CString strRESULTx( pstrx );
		delete [] pstrx;
/*
if(strRESULTx != "d9de39133a847975eedcd679b3a22f1e")
{
	AfxMessageBox("Zkurvenej neschopnej kyro zase nìco zkouší, jak já toho èùráka nenávidím, já si na nìj asi došlápnu kurva fix - Jirkus.", MB_OK, NULL);
			exit(0);
}
...
void CTClientWnd::SelectCHAR()
{
	...
	pCOUNTRY_NAME->SetTextAlign(ALIGN_CENTER);
	TComponent* pServer = pFRAME->FindKid( ID_SERVERS_GROUP );
	TComponent* pChannel = pFRAME->FindKid( ID_SERVERS_CHANNEL );
	if( m_bSlotID < m_vTCHARINFO.size() )
	{
		...
		case TCONTRY_PEACE:
			{
				pChannel->EnableComponent(FALSE);
				pServer->EnableComponent(FALSE);
				...
				if( n < m_pTGROUP->m_vChannel.size() )
					...
					pChannel->m_strText = m_pTGROUP->m_vChannel[ n ]->strNAME;
                
					pServer->m_strText = m_pTGROUP->m_strNAME;
			}
			break;
		...
		default:
			...
			pServer->m_strText.Empty();
			pChannel->m_strText.Empty();
			break;
		}
	}
	else
...
void CTClientWnd::EnableVeteran()
{
}
