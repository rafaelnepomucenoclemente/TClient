...
#define ID_BONUS_TEXT (0x000068B3)
// CTCashCabinetDlg
// ====================================================================================================
...
void CTCashCabinetDlg::SetupComponent()
{
	...
	m_pExtensionPeriodBtn = FindKid(ID_BUT_1);
...
*/
	...
	m_pBonus = FindKid(ID_BONUS_TEXT);

	m_pCashText = FindKid(ID_CTRLINST_TXT_CASH);
	m_pCashText->m_strText = "";
	m_pCashText->SetTextAlign( ALIGN_LEFT );
								...
								DWORD dwBonusCash )
{
    ...
    //solidní randál :D
	strCASH.Format("Cash Points : %d", m_dwCash);
	strBONUS.Format("Bonus : %d", m_dwBonusCash);

	m_pCashText->m_strText = strCASH;
	m_pBonus->m_strText = strBONUS;
}
