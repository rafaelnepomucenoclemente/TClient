...
CTDynamicHelpNewDlg::CTDynamicHelpNewDlg( TComponent *pParent, LP_FRAMEDESC pDesc )
: CTClientUIBase( pParent, pDesc )
{

	m_pText = static_cast<TComponent *>(FindKid(ID_HELP_IMAGE));
	m_pTEX = NULL;
	m_pVB = NULL;
...
CTDynamicHelpNewDlg::~CTDynamicHelpNewDlg()
{
//Release();
}

void CTDynamicHelpNewDlg::Release()
{
	if(m_pTEX)
	{
...
void CTDynamicHelpNewDlg::InitTEXT( CString& strTEXT)
{
...
HRESULT CTDynamicHelpNewDlg::Render( DWORD dwTickCount)
{
	if(!IsVisible())
		return S_OK;
