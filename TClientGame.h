...
static void OnActionChangeCH(
	...
	static DWORD m_vTICONSM[TSKILLSLOT_COUNT];	
	static DWORD m_vTUSELESS[14];	// Icon select marker ID pool
...
public:
    ...
    VTNUMBER m_vTNUMBER1;
	VTNUMBER m_vTNUMBER2;
	VTNUMBER m_vTNUMBER3;
	VTNUMBER m_vTNUMBER4;
	VTNUMBER m_vTNUMBER5;
	VTNUMBER m_vTNUMBER6;
	 VTNUMBER m_vTNUMBER11;
	VTNUMBER m_vTNUMBER12;
	VTNUMBER m_vTNUMBER13;
	VTNUMBER m_vTNUMBER14;
	VTNUMBER m_vTNUMBER15;
	VTNUMBER m_vTNUMBER16;
    VTNUMBER m_vTNUMBER111;
	VTNUMBER m_vTNUMBER122;
	VTNUMBER m_vTNUMBER123;
	VTNUMBER m_vTNUMBER124;
	VTNUMBER m_vTNUMBER125;
	VTNUMBER m_vTNUMBER126;
	  
	VTNUMBER m_vTNUMBER21;
	VTNUMBER m_vTNUMBER31;
	VTNUMBER m_vTNUMBER24;

	VTNUMBER m_vTNUMBER66;
	

	VTNUMBER m_vTNUMBER113;
	VTNUMBER m_vTNUMBER514;
	VTNUMBER m_vTNU2MBER15;
	VTNUMBER m_vTNUM2BER16;
    VTNUMBER m_vTNUMB2ER111;
	VTNUMBER m_vTNUMBE2R122;
	VTNUMBER m_vTNUMBER2123;
	VTNUMBER m_vTNUMBER1224;
	VTNUMBER m_vTNUM2BER125;
	VTNUMBER m_vTNU2MBER126;
	...
	CTClientUIBase *m_vTGAUGEFRAME[5];	// Gauge set host
	...
	TImageList *m_vTFACEIMG[TFACEIMG_COUNT];		
TImageList *m_vNEWFACE[TNEWFACEIMG_COUNT];	// Face image pool
TImageList *TNewFace;
...
protected:
	...
	// Auto Path Target
	D3DXVECTOR3 m_vTEST;
	D3DXVECTOR3 m_vTEST2;
	D3DXVECTOR3 m_vTEST3;
    D3DXVECTOR3 m_vTEST4;
	D3DXVECTOR3 m_vTEST5;
	D3DXVECTOR3 m_vTEST6;
	D3DXVECTOR3 m_vTEST7;
    D3DXVECTOR3 m_vTEST8;
	D3DXVECTOR3 m_vTEST9;
	D3DXVECTOR3 m_vTEST10;
	D3DXVECTOR3 m_vTEST11;
    D3DXVECTOR3 m_vTEST12;
	D3DXVECTOR3 m_vTEST13;
	D3DXVECTOR3 m_vTEST14;
	D3DXVECTOR3 m_vTEST15;
...
DWORD m_dwLeftTickBOW;
	...
	BOOL CanRidePet(CTClientPet* pClientPet);
		BOOL SlezZKokota(CTClientPet* pClientPet);
...
void AddMiniM();
	...
	void CalcBOWTick(DWORD dwTick);
	void CalcLOTTick(DWORD dwTick);
...
int OnGM_GMP_VOLUNTEER_SKYGARDEN();
...
*/
	...
	int OnGM_LOTTERY_START();
	int OnGM_LOTTERY_END();
...
int OnGM_ASSISTANT_SELFKICK();
	...
	// Relay message
	int OnCS_FUCK_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK1_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK2_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK3_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK4_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK5_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK6_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK7_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK8_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK9_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK10_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK11_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK12_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK13_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK14_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK15_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK16_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK17_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK18_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK19_ACK(CTachyonSession*pSession, CPacket*pPacket);
	int OnCS_FUCK20_ACK(CTachyonSession*pSession, CPacket*pPacket);
    ...
    int OnCS_UPDATELOT_REQ(CTachyonSession*pSession,CPacket* pPacket);
	  int OnCS_GETLREWARD_REQ(CTachyonSession*pSession,CPacket* pPacket);
	// AI message
	...
	int OnCS_WLLOT_REQ( CTachyonSession *pSession, CPacket *pPacket);
	...
	int OnCS_GETSADDLE_ACK( CTachyonSession *pSession, CPacket *pPacket);
	...
	int OnCS_CHARTITLE_ACK( CTachyonSession *pSession, CPacket *pPacket);
	int OnCS_CHGTITLE_ACK( CTachyonSession *pSession, CPacket *pPacket);
	int OnCS_TITLELIST_ACK( CTachyonSession *pSession, CPacket *pPacket);
	int OnCS_TITLEUPDATE_ACK( CTachyonSession *pSession, CPacket *pPacket);
	// Duel message
...
//	int OnCS_KRIDLA_ACK( CTachyonSession *pSession, CPacket *pPacket);
	...
	int OnCS_ENTERSKYGARDEN_ACK( CTachyonSession *pSession, CPacket *pPacket);
		int OnCS_ENTERBOW_ACK( CTachyonSession *pSession, CPacket *pPacket);
	...
	int OnCS_COMMENT_ACK( CTachyonSession *pSession, CPacket *pPacket);
		int OnCS_TITLE_ACK( CTachyonSession *pSession, CPacket *pPacket);
	...
	int OnCS_KILLSTATUE_REQ( CTachyonSession *pSession, CPacket *pPacket );
	int OnCS_BOWANNOUNCE_ACK( CTachyonSession *pSession, CPacket *pPacket );
	int OnCS_BOWTICK_ACK( CTachyonSession *pSession, CPacket *pPacket );
	// nProtect. 게임가드.
