...
void CTClientSession::SendCS_CHECKLOTEND_REQ( DWORD dwCharID )
{
	CPacket vMSG;

	vMSG.SetID(CS_CHECKLOTEND_REQ)
		<< dwCharID;
...
void CTClientSession::SendCS_CHGTITLE_REQ(WORD wCharTitleID)
{
	CPacket vMSG;

	vMSG.SetID(CS_CHGTITLE_REQ)
		<< wCharTitleID;
...
void CTClientSession::SendCS_BOWREG_REQ(DWORD dwID)
{
	CPacket vMSG;

	vMSG.SetID(CS_BOWREG_REQ)
		<< dwID;
...
void CTClientSession::SendCS_SADDLE_REQ( BYTE bInvenID, BYTE bItemID )
{
	CPacket vMSG;
	vMSG.SetID( CS_SADDLE_REQ );
...
void CTClientSession::SendCS_RESETLOT_REQ(DWORD dwCharID)
{
	CPacket vMSG;
	vMSG.SetID(CS_RESETLOT_REQ)
		<< dwCharID;
